        ...
        <Container>
            <div className="card my-5">
                ...
                <div className="card-body">
                    ...
                    <a href="https://reactrouter.com/en/main" className="btn btn-outline-info mb-3 fs-5">See More</a>
                </div>
            </div>
            <div className="card my-5">
                <div className="card-header bg-dark text-white fs-3">
                ...
                <div className="card-body">
                    ...
                    <a href="https://beta.reactjs.org/apis/react/createContext" className="btn btn-outline-info mb-3 fs-5">See More</a>
                </div>
            </div>
            <div className="card my-5">
                <div className="card-header bg-dark text-white fs-3">
                ...
                <div className="card-body">
                    ...
                    <a href="https://beta.reactjs.org/apis/react/useRef#useref" className="btn btn-outline-info mb-3 fs-5">See More</a>
                </div>
            </div>
        </Container>
    )
